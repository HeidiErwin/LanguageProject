...
public class EvaluationRule {
    ...
    public static readonly EvaluationRule ALL = new EvaluationRule(
        new ExpressionPattern(Expression.ALL, new MetaVariable(SemanticType.PREDICATE, 0)),
        new EvaluationPattern[]{new EvaluationPattern(new MetaVariable(SemanticType.PREDICATE, 0), EntailmentContext.Downward)},
        new ExpressionPattern(Expression.ALL, new MetaVariable(SemanticType.PREDICATE, -1)));
